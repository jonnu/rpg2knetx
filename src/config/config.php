...
|
*/
$config['log_path'] = '/work/2k/logs/ci/';
...
|--------------------------------------------------------------------------
|
| Files can be automatically loaded during runtime in order to lower the 
| number of includes within child files. You may define several folders 
| that will have resources automatically required on load.
|
*/
